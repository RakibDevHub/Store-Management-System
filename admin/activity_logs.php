                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control" placeholder="Search by user, action, description, or IP address..." value="<?php echo htmlspecialchars($search); ?>">
                            </div>
                        </div>
                    </div>
            ...
            <nav class="mt-4">
                <ul class="pagination justify-content-center">
                    <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
                        <a class="page-link" href="?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&limit=<?php echo $limit; ?>">
                    ...
                    if ($start_page > 1) {
                        echo '<li class="page-item"><a class="page-link" href="?page=1&search=' . urlencode($search) . '&from_date=' . $from_date . '&to_date=' . $to_date . '&limit=' . $limit . '">1</a></li>';
                    ...
                    ?>
                        <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                            <a class="page-link" href="?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&limit=<?php echo $limit; ?>">
                                <?php echo $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
                    ...
                    if ($end_page < $total_pages) {
                        ...
                        echo '<li class="page-item"><a class="page-link" href="?page=' . $total_pages . '&search=' . urlencode($search) . '&from_date=' . $from_date . '&to_date=' . $to_date . '&limit=' . $limit . '">' . $total_pages . '</a></li>';
                    }
                    ?>
...
if (isset($_GET['export']) && $_GET['export'] == 'csv') {
    ...
    if (!empty($search)) $export_sql .= " AND (al.description LIKE '%$search%' OR u.first_name LIKE '%$search%' OR u.last_name LIKE '%$search%' OR u.email LIKE '%$search%' OR al.action LIKE '%$search%')";
